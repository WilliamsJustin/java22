...
```txt
 git commit -m "init project"
   19  git config --global user.name gzpeterz
   20  git config --global gzpeterz@163.com
   21  git config --global user.email gzpeterz@163.com
   22  git commit -m "init project"
   23  git config --list
   24  cd ..
   25  rm -Rf first
   26  mkdir first
   ...
   29  cd ..
   30  ls -al
   31  git clone https://gitee.com/gzpeterz/hello.git
   32  ls -al
   33  cd hello/
   34  ls -al
   35  git log
   36  cd ..
   37  git clone https://gitee.com/smallweigit/avue.git
   38  ls -al
   39  cd avue
   40  git log
   41  cd ..
   42  git clone https://github.com/git/git
   43  git clone https://github.com/git/git
   44  git clone https://github.com/git/git
   45  cd hello/
   46  ls -al
   47  vi student7.txt
   48  vi z.txt
   49  git add z.txt
   50  git commit -m "test push"
   51  git push
   52  git pull
   53  vi demo.txt
   54  history
...
- git merge [name]                        合并分支
 ...
 mkdir second
  ...
  118  vi a.txt
  # 提交 2
  119  git commit -a -m "c1"
  
  # 查看分支的情况
  120  git log --oneline --all --graph
  # 创建分支
  121  git branch test
  # 查看分支
  122  git branch
  ...
  # 在master 里面 合并了 分支 test
  135  git merge test
  136  ls -al
  137  cat c.txt
  138  git log --oneline --all --graph
  139  ls -al
  140  cat b.txt
  141  cat c.txt
  ...
  # 在 test 分支里面合并了 master
  146  git merge master
  147  cat b.txt
  148  git log --oneline --all --graph
  149  history
...
```txt
 cd ..
  ...
  153  ls -al
  154  git init
  155  touch a.txt b.txt c.txt
  156  git add *
  157  git commit -m "c0"
  158  vi a.txt
  159  git commit -a -m "c1"
  160  vi b.txt
  161  git commit -a -m "c2"
  # 项目提交情况
  162  git log --oneline --all --graph
  
  # 开始 iss53 新需求的开发
  163  git checkout -b iss53
  164  git log --oneline --all --graph
  165  vi c.txt
  166  git commit -a -m "c3"
  167  git log --oneline --all --graph
  
  # 接到电话， 开始 紧急故障的修复 hotfix
  168  git checkout master
  169  git checkout -b hotfix
  170  touch fix.txt
  171  vi fix.txt
  172  git add fix.txt
  173  git commit -m "c4"
  174  git log --oneline --all --graph
  175  git checkout master
  176  git merge hotfix
  # 修复完成 hotfix
  177  ls -al
  178  cat c.txt
  179  cat fix.txt
  180  git log --oneline --all --graph
  # 删除 hotfix分支
  181  git branch -d hotfix
  182  git log --oneline --all --graph
  
  # 接着开发 新需求
  183  git checkout iss53
  184  history
...
```txt
  history
  185  git log --oneline --all --graph
  186  ls -al
  187  vi c.txt
  188  vi c.txt
  189  git commit -a -m "c5"
  # 新需求开发完成
  190  git log --oneline --all --graph
  191  git checkout master
  
  # 进行了 一个 三方合并的操作
  192  git merge iss53
  193  git log --oneline --all --graph
  194  ls -al
  195  cat c.txt
  196  cat fix.txt
  197  git log --oneline --all --graph
  198  history
...
![1700464791791](Git课程讲义.assets/1700464791791.png)
...
```txt
 mkdir exam3
  223  cd exam3/
  224  git init
  225  touch a.txt b.txt c.txt
  226  git add *
  227  git commit -m "c1"
  228  vi a.txt
  229  git commit -a -m "c2"
  230  vi a.txt
  231  git commit -a -m "c3"
  232  git log --oneline --all --graph
  233  git remote add origin https://gitee.com/gzpeterz/exam3.git
  234  git push -u origin master
  235  git log --oneline --all --graph
  236  vi c.txt
  237  git commit -a -m "c6"
  238  vi c.txt
  239  git commit -a -m "c7"
  240  git log --oneline --all --graph
  241  git fetch
...
![1700469045099](Git课程讲义.assets/1700469045099.png)
