...
- 实际上计算机最终所执行的都是 机器语言，它是由“0”和“1”组成的二进制数，二进制是计算机语言的基础。
  ...
  0010  =  2
  1000  =   1 * 2^3 = 8
  abcd =  a*2^3 + b*2^2 + c*2^1 + d*1 = 8 + 4 + 2 + 1 = 15
  
  
  1111  + 0001 =  10000 = 16 - 1 = 15
...
### 1.5 编程语言和标记语言区别（html）

| 语言     | 说明                                                         |
| -------- | ------------------------------------------------------------ |
| 编程语言 | 编程语言有很强的逻辑和行为能力。在编程语言里, 你会看到很多 if else 、for 、while等具有逻辑性和行为能力的指令，这是主动的。带判断能力 和执行能力 |
| 标记语言 | 标记语言（html）不用于向计算机发出指令，常用于格式化和链接。标记语言的存在是用来被读取的, 他是被动的。主要是用来展示界面和内容 。前端 。（js） |
...
```txt
bit 位。  1010 1000 = 8 bit
Byte 比特  1byte （1010 0001） = 8 bit 
KB  kilometer Byte   1KB = 1024 Byte
MB   million Byte (百万)=1000*1000   1MB = 1024KB
GB      1GB = 1024MB
TB      1TB = 1024GB  （ 1TB = 1000GB）
---------------------------------------------
一般我们 提到存储设备。  300M 宽带 。  100M，
 200M。
 Byte。  
 如果是 网络速度的单位， 都 bit 。 300M = 300*1024*bit
```
...
![image-20210623140429725](JavaScript基础第01天笔记.assets/image-20210623140429725.png)
...
- JavaScript 是世界上最流行的语言之一，是一种运行在客户端的脚本语言 （Script 是脚本的意思）github
- 脚本语言：不需要编译，运行过程中由 js 解释器( js 引擎）逐行来进行解释并执行
- 现在也可以基于 Node.js 技术进行服务器端编程  （js全栈工程师）
...
![image-20210624090004496](JavaScript基础第01天笔记.assets/image-20210624090004496.png)
  ...
  2. 数字型范围
     ...
     - 最小值：Number.MIN_VALUE，这个值为：5e-32
       ...
       ```txt
        ...
        1.79769... * 10^308
        179769...  000000000000000000000000000000000000000000000000000000
...
- 字符串型 String
  ...
  2. 字符串转义符
     ...
     <img src="JavaScript基础第01天笔记.assets/image-20210624113702732.png" alt="image-20210624113702732" style="zoom:80%;" />
  ...
  5. 字符串拼接加强
     ...
     console.log('老师' + age + '岁啦'); // pin老师18岁啦
     ```
...
- 字面量
  ...
  - 布尔字面量：true，false
    ...
    ```txt
    NaN,  null,  undefined, true, false 都是 字面量。 都不带引号 。
    ```
