...
3. 字符串的长度
   ...
   ```txt
   var str = 'dksajdfkafjka';   // 字符串
   var len = str.length;   // 数字型
   alert(str.length);
   len = len * 2;
   ```
...
4. number 变量拼字符串
   ...
   ```txt
   var num1 = 100, num2 = 300, str = 'ok';
   
   var all = num1 + num2 + str; // 400ok
   
   all =  '' + num1 + num2 + str  // 100300ok
...
5. typeof 使用方式
   ...
   type = typeof 'aaabb ccd';
   
   var age = prompt('please input your age');
   console.log(typeof age);  //  ??  string
   console.log(age.length)  // 1   2   
   ```
...
```txt
var number = prompt('please input a number');  1998  2001  3555
var num = parseInt(number);  1998
4 个数字：   1   9  9  8  number
