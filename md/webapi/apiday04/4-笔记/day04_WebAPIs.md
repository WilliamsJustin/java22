...
![img](day04_WebAPIs.assets/SNAGHTML6fdd67b8.PNG)
...
```js
    ...
    <script>
        ...
        btn.addEventListener('click', function() {
            ...
            location.href = 'http://www.chinasoft.cn';
        })
        var timer = 5;
        setInterval(function() {
            if (timer == 0) {
...
```js
    ...
    <script>
        ...
        btn.addEventListener('click', function() {
            // 记录浏览历史，所以可以实现后退功能
            // location.assign('http://www.chinasoft.cn');
            // 不记录浏览历史，所以不可以实现后退功能
            // location.replace('http://www.chinasoft.cn');
